...
class Planner:
    ...
    def __init__(self, grid_size: int,
        ...
        self.grid = Grid(grid_size, np_static_obstacles, height, length)
    ...
    def check_boundry (self, currentpos: np.ndarray) -> bool:
        return currentpos[0] - self.robot_radius < 0 or currentpos[0] + self.robot_radius > self.length or \
               currentpos[1] - self.robot_radius < 0 or currentpos[1] + self.robot_radius > self.height
    '''
    Space-Time A*
    '''
        ...
        while open_set and iter_ < max_iter:
            ...
            for neighbour in self.neighbour_table.lookup(current_state.pos):
                ...
                if not self.safe_static(neighbour) \
                        ...
                        or self.check_boundry(neighbour)\
